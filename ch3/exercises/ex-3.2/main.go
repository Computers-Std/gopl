...
type zFunction func(x, y float64) float64

func Svg(w io.Writer, f zFunction) {
...
func corner(i, j int, f zFunction) (float64, float64) {
...
func main() {
	usage := "usage: ex-3.2 saddle|eggbox"
	if len(os.Args) < 2 {
